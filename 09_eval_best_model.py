...
# ====================== 1. 配置项 ======================
MODEL_PATH = r"C:\Users\Administrator\Desktop\P-P\cluster_split_v3_A2\partner_only_DSSP\07_model_save\best_model.pth"  # 确保名字和12_train保存的一致
OUTPUT_DIR = r"C:\Users\Administrator\Desktop\P-P\cluster_split_v3_A2\partner_only_DSSP\07_model_save"  # 图表输出路径
